...
const PALETTES: Palette[] = [
  { label: "Ocean", colors: ["#2563eb", "#0891b2", "#06b6d4"] },
  { label: "Forest", colors: ["#16a34a", "#15803d", "#84cc16"] },
  { label: "Sunset", colors: ["#ea580c", "#dc2626", "#f59e0b"] },
  { label: "Purple", colors: ["#7c3aed", "#6366f1", "#8b5cf6"] },
  { label: "Slate", colors: ["#475569", "#64748b", "#94a3b8"] },
];
