...
Return ONLY a valid JSON object matching this exact shape (no markdown fences):
{
  ...
  "surfaceGradient": "linear-gradient(180deg, <bg> 0%, <surfaceAlt> 100%)",
  "useGradient": true,
  "borderRadius": <number 4-20>,
  "dark": {
    "primary": "<hex>", "secondary": "<hex>", "tertiary": "<hex>",
    "success": "<hex>", "warning": "<hex>", "error": "<hex>",
    "background": "<hex>", "surface": "<hex>", "surfaceAlt": "<hex>",
    "border": "<hex>", "highlight": "<hex>", "accent": "<hex>",
    "text": "<hex>", "textSecondary": "<hex>", "textMuted": "<hex>"
  },
  "light": {
    "primary": "<hex>", "secondary": "<hex>", "tertiary": "<hex>",
    "success": "<hex>", "warning": "<hex>", "error": "<hex>",
...
- tertiary: a third accent color that complements primary/secondary.
- surfaceAlt: a slightly different surface for sidebars, drawers, alternating rows.
- border: explicit border/divider color (not auto-derived).
- highlight: subtle background tint for hover states and active rows.
- accent: the single strongest brand color for focal elements.
- textMuted: dimmer than textSecondary, for disabled or decorative text.
- Create visual depth: background < surface < surfaceAlt should form a clear
  layering progression. Borders should be visible but not harsh.
- surfaceGradient: a subtle vertical gradient from background to surfaceAlt,
  used on the page body for depth. Use 180deg direction.
- accentGradient: used on buttons, progress bars, chips, and active indicators.
  Use 135deg direction with two or three color stops for richness.
- Always set useGradient to true unless the user specifically asks for flat/solid.
- Lean into gradients: they bring warmth and dimensionality.`;
